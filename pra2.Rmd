...
Aceptaremos la hipótesis nula cuando el p-value que nos devuelva el test sea mayor a 0.05 (p_value \> 0.05) Rechazaremos la hipótesis nula, por lo tanto, aceptamos la alternativa en caso contrario (p_value \< 0.05)
